...
print("Each of you will roll your dice 3 times. By the end of the 3 rounds, the player who crossed out the most numbers is the WINNER.")
...
if dicechoice == 6 :
	print("You chose the 6-sided dice. Make sure you write 1 2 3 4 5 6 on your paper.", playeronename, ", your dice will automatically roll for you in a few seconds." )

if dicechoice == 4  :
	print("You chose the 4-sided dice. Make sure you write 1 2 3 4 on your paper.", playeronename, ", your dice will automatically roll for you in a few seconds." )	
